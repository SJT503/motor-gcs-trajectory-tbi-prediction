# -*- coding: utf-8 -*-
# Fig 3 — (a) calibration deciles ×3 db (frozen v2), (b) held-out-half calibration before/after logistic recalibration (eICU, M3),
...
#         Numbered by first citation in the manuscript (calibration cited in Results §3, before the early-warning figure).
